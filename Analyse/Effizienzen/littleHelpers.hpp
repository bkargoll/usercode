...
TH1D* histoFromTree(TString name, TTree* sample, TString variable, TString selection, unsigned int nBins, double low, double high, TString options="", TString xtitle = "test", double xtitleOffset=1.1, double ytitleOffset=1.1){
